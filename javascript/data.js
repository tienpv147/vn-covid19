...
Promise.all([fetch(apiCaBenh), fetch(apiCaBenhTheoNgay), fetch(apiDuDoanTongCaBenh)])
...
const getDuDoanTongCaBenh = (data) => {
  // duDoanTongCaBenhArray.push()
  duDoanTongCaBenhArray = data[2].map(({date, confirmed}) => ([[date, confirmed]]))

  console.log(cachliArray)
  console.log(duDoanTongCaBenhArray)
}
